...
const ChatWidget: React.FC = () => {
  ...
  // The Firestore load is async; sendMessage awaits it (and reads the ref, not the
  ...
  useEffect(() => {
    ...
    const loadCandidates = async () => {
      try {
        ...
        if (!user) {
          const built = buildCandidates([], fallbackName);
    ...
    candidatesLoadRef.current = loadCandidates();
  }, [isOpen]);
